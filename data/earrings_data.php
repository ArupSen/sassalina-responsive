...
$items = array(
  ...
  array('Asscher cut Diamond Earrings','Truly beautiful claw set Asscher cut (octagonal) Diamond earrings total weight 2 cts, set in Platinum.  These stones are GIA certified as D colour and VVS1 quality.'),
  ...
  array('Kunzite and Diamond earrings','My client bought an unusual 50th birthday gift of a Diamond brooch with watch attached to me,  we incorporated the antique drop Diamonds (original setting) to attach to oval (1.88cts) and cushion cut (3.67cts) Kunzites to create the most stunning earrings.'),
  ...
  array('Asscher cut Diamonds','A pair of Asscher cut Diamonds (total weight 2.22cts) surrounded but 1ct of natural pink Diamonds set in 18ct Rose Gold to attach with the diamond hoops....These could be created all in white diamonds or with other coloured gemstones.'),
  ...
  array('Yellow Sapphire and Spessartite earrings','Brilliant cut yellow Sapphires (2.72cts) bezel set as studs in 18ct yellow gold with pear shaped Spessartite Garnet drops.  Fab and original colour combination....'),
  array('Aquamarine stud earrings','A gorgeous pair of 7mm x 7mm cushion cut Aquamarines set to make simple studs in Platinum.'),
  array('Claret Tourmaline earrings','A few school friends grouped together to commission these gorgeous oval tourmaline earrings (5.73cts) set in rose gold for a very special birthday gift.'),
