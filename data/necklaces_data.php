...
$items = array(
  ...
  array('Gold and Diamond Star Pendant','My client had inherited a very sentimental diamond engagement ring form her grandmother but had no need for another ring, I knew she liked stars and so I suggested we design one adding a few additional diamonds to bring this sparkly star to life….'),
  array('Personalised diamond and gold necklace','Graduating from High School and leaving London to go College in the States is a big event in anyones life…to celebrate the occasion two bespoke necklaces were made with nicknames the Mother and Daughter had for each other….I only have a photo of one as the other is already transatlantic!'),
